        ...
        <div class="row row-zakat">
            <div class="col-md-5" id='hide-content'>
                <div class="right-content mt-5" style="padding-left: 10%; padding-right: 10%; width: 100%; height: auto; position: relative; transform: translateY(8%);">
                    ...
                    <div class="latin text-white mt-5" style="text-align: left; font-size: clamp(20px, 3vw, 36px); font-weight: 700;">
                        SIAP BAYAR ZAKAT <br>
                        SEKARANG?
                    </div>
                    <div class="latin text-white" style="text-align: left; font-size: clamp(14px, 3vw, 18px);">
                    ...
                    <div class="latin text-white" style="text-align: left; font-size: clamp(10px, 3vw, 15px); margin-top: 100px;">
                        Periode
                    </div>
