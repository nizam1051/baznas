...
<section class="page-section" id="about">
    <div class="container">
        ...
        <p class="text-content">
            &emsp;&emsp;Bantuan Perbaikan Masjid, Bisyaroh Marbot/Muadzin, Bisyaroh Ustadz-Ustadzah, Guru TPA/RA/TK/ PAUD, Penyuluh
            Non ASN,dsb.
        </p>
        <br>
        ...
        <p class="">    <!--tadi tulisane class text content-->
