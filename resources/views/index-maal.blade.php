                    ...
                    <div class="row">
                        <div class="mt-3 col-sm-6 col-lg-4 col-md-4">
                            <div class="card" style="border-radius: 15px; max-height: 400px;">
                                <img src="assets/img/baznas.jpeg" class="card-img-top" alt=""
                                    style="background-color: #FF9900; border-top-left-radius: 15px; border-top-right-radius: 15px; min-height: 250px; max-height: 300px;">
                                <div class="card-body"
                        ...
                        <div class="mt-3 col-sm-6 col-lg-4 col-md-4">
                            <div class="card" style="border-radius: 15px; max-height: 400px;">
                                <img src="assets/img/zakat.jpg" class="card-img-top" alt=""
                                    style="background-color: #FF9900; border-top-left-radius: 15px; border-top-right-radius: 15px; min-height: 250px; max-height: 300px;">
                                <div class="card-body"
                                    style="background-color: #FF9900; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px; ">
                        ...
                        <div class="mt-3 col-sm-6 col-lg-4 col-md-4">
                            <div class="card" style="border-radius: 15px; max-height: 400px;">
                                <img src="assets/img/infaq.jpg" class="card-img-top" alt=""
                                    style="background-color: #FF9900; border-top-left-radius: 15px; border-top-right-radius: 15px; min-height: 250px;max-height: 300px;">
                                <div class="card-body"
                                    style="background-color: #FF9900; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px; ">
                        ...
                        <div class="col-md-6 mt-5">
                            <div class="card">
                                <div class="card-body" style="background-color: #01502D;">
                                    ...
                                    <div>&nbsp;</div>
                                    <form action="{{ url('index-maal') }}" method="POST"
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" class="form-control"
                                                    id="autoSizingInputGroup" name="gaji">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group">
                                                <div class="input-group-text">Rp</div>
                                                <input type="number" min="0" class="form-control"
                                                    id="autoSizingInputGroup" name="tunjangan">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-auto">
                                            <div class="input-group">
                                                <div class="input-group-text">Rp</div>
                                                <input type="number" min="0" class="form-control"
                                                    id="autoSizingInputGroup" name="hutang">
                                            </div>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary2"
                                            style="background-color: #FF9900; border-color: #FF9900;">Hitung</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mt-5">
                            <div class="container">
                                ...
                                <p style="color: black; text-align: justify; font-size: clamp(13px, 1vw, 17px);">
                                    ...
                                    untuk disimpan dan dimiliki oleh seseorang.</p>
                                <h6 style="color: black; text-align: left;"><b>Nilai Zakat Mal</b></h6>
                                @if (session('total'))
                                <div class="col-auto">
                                    <div class="input-group">
                                        <div class="input-group-text">Rp</div>
                                        <input type="text" class="form-control" value="{{ number_format(session('total')) }}"
                                            id="autoSizingInputGroup" readonly>
                                    </div>
                                </div>
                                @else
                                <div class="col-auto">
                                    <div class="input-group">
                                        <div class="input-group-text">Rp</div>
                                        <input type="text" class="form-control" value="0" id="autoSizingInputGroup"
                                            readonly>
                                    </div>
                                </div>
                                @endif
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <div class="card" style="border-radius: 15px; height: auto;">
                                        <img src="assets/gallery/01a.jpg" alt="01a"
                                            style="border-radius: 15px; height: 150px;">
                                    </div>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <div class="card" style="border-radius: 15px; height: auto;">
                                        <img src="assets/gallery/02a.jpg" alt="02a"
                                            style="border-radius: 15px; height: 150px;">
                                    </div>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <div class="card" style="border-radius: 15px; height: auto;">
                                        <img src="assets/gallery/03a.jpg" alt="03a"
                                            style="border-radius: 15px; height: 150px;">
                                    </div>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <div class="card" style="border-radius: 15px; height: auto;">
                                        <img src="assets/gallery/04a.jpg" alt="03a"
                                            style="border-radius: 15px; height: 150px;">
                                    </div>
                                </div>
                            </div>
