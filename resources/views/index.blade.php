            ...
            <div class="row gx-4 gx-lg-5">
                <div class="col-lg-3 col-md-6 col-6 text-center">
                    <div class="mt-5" style="background-color: white; border-radius: 15px; height: 200px">
                        ...
                        <h2 class="mb-2" style="color: #FF9900;font-size: 1.7rem;"><b>{{ number_format($penyalur->penerima, 0, '.', '.') }}</b></h2>
                        <div>&nbsp;</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-6 text-center">
                    <div class="mt-5" style="background-color: white; border-radius: 15px; height: 200px">
                        ...
                        <h2 class="mb-2" style="color: #FF9900;font-size: 1.7rem;"><b>{{ number_format($penyalur->penghimpun, 0, '.', '.') }}</b></h2>
                        <div>&nbsp;</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-6 text-center">
                ...
                <div class="col-lg-3 col-md-6 col-6 text-center">
                    <div class="mt-5" style="background-color: white; border-radius: 15px; height: 200px">
                        ...
                        <h2 class="mb-2" style="color: #FF9900;font-size: 1.7rem;"><b>{{ number_format($penyalur->donatur, 0, '.', '.') }}</b></h2>
                        <div>&nbsp;</div>
                    </div>
                </div>
                <div>&nbsp;</div>
    ...
    <section class="" id="about">
        ...
        <div class="d-flex justify-content-center">
            <div class="container">
                ...
                <center>
                    <canvas id="myChart" class="mt-2" style="width:100%;max-width:700px;"></canvas>
                </center>
            </div>
        </div>
    </section>
